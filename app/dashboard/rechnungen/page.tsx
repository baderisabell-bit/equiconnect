    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
      ...
      <aside className={`fixed left-0 top-0 h-full w-72 bg-white z-[70] shadow-2xl transition-transform duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} p-6 flex flex-col`}>
        ...
        <nav className="space-y-5 flex-grow">
          ...
          {isExpert && <button type="button" onClick={() => { setSidebarOpen(false); router.push("/dashboard/rechnungen"); }} className="block text-left text-lg font-black italic uppercase text-slate-800 hover:text-emerald-600">Rechnungen</button>}
